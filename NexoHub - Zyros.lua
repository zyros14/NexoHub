...
local TempleRemote = Remotes:WaitForChild("Temple")
...
local MobileUIModeUpdated = Remotes:WaitForChild("MobileUIModeUpdated")
local SetMobileMouseLockMode = Remotes:WaitForChild("SetMobileMouseLockMode")
local GetCurrentMobileMouseLockMode = Remotes:WaitForChild("GetCurrentMobileMouseLockMode")
local IsObservationActive = Remotes:WaitForChild("IsObservationActive")
local SetQATaskStatus = Remotes:WaitForChild("SetQATaskStatus")
local ShootSoulGuitar = Remotes:WaitForChild("ShootSoulGuitar")
local ActivateHomeButton = Remotes:WaitForChild("ActivateHomeButton")
local ActivateRaceV4 = Remotes:WaitForChild("ActivateRaceV4")
local ActivatedSkill = Remotes:WaitForChild("ActivatedSkill")
local CelestialAwakenTransition = Remotes:WaitForChild("CelestialAwakenTransition")
local DeactivatedSkill = Remotes:WaitForChild("DeactivatedSkill")
local DomainEasterRequest = Remotes:WaitForChild("DomainEasterRequest")
local EnablePvP = Remotes:WaitForChild("EnablePvP")
local PlaySkillCooldownAnimation = Remotes:WaitForChild("PlaySkillCooldownAnimation")
local ToggleAllies = Remotes:WaitForChild("ToggleAllies")
local ToggleCodesWindow = Remotes:WaitForChild("ToggleCodesWindow")
local ToggleCrewWindow = Remotes:WaitForChild("ToggleCrewWindow")
local ToggleInventoryWindow = Remotes:WaitForChild("ToggleInventoryWindow")
local ToggleMusic = Remotes:WaitForChild("ToggleMusic")
local ToggleSettingsWindow = Remotes:WaitForChild("ToggleSettingsWindow")
local UsedRaceSkill = Remotes:WaitForChild("UsedRaceSkill")
local EasterServiceStreaming = Remotes:WaitForChild("EasterServiceStreaming")
local AssignQATask = Remotes:WaitForChild("AssignQATask")
